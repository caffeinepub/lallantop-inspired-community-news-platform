...
export default function DashboardPage() {
  ...
  const { data: myProfile, isLoading: profileLoading, isFetched, error: profileError } = useMyProfile();
  ...
  // ── Unassigned user (also handles error state — treat as no role) ───────────
  if ((isFetched && !myProfile) || profileError) {
    return (
